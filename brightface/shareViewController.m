...
//        NSLog(@"share to facebook1");
        ...
        [controller setInitialText:@"#brightface created with brightface app"];
...
//    {
    if ([[UIApplication sharedApplication] canOpenURL:[NSURL URLWithString:@"twitter://"]]) {
        ...
        [tweetSheet setInitialText:@"#brightface created with @brightface"];
...
//        
//        [controller setInitialText:@"#brightface created with @brightface"];
//        [controller addImage:self.image];
//        
//        [self presentViewController:controller animated:YES completion:nil];
//        
...
//        NSLog(@"image size: %@", NSStringFromCGSize(instaImage.size));
    ...
    _docController.annotation = [NSDictionary dictionaryWithObject:@"#brightface created with @brightface" forKey:@"InstagramCaption"];
...
- (IBAction)sendMail:(UIButton *)sender  
{
    ...
    [pickerMail setSubject:@"I created a brightface!"];
...
//    NSString *encodedString = [inputData base64EncodedString];      //encode
    NSString *string= @"Check it out!  \n\n______\nCreated using brightface app.  Download for free! \nhttp://itunes.apple.com/app/id952786359";
//    if (isImage)
...
//    NSArray *recipents = @[@"12345678", @"72345524"];
    NSString *message = [NSString stringWithFormat:@"created using brightface app.  download for free! \nhttp://itunes.apple.com/app/id952786359"];
