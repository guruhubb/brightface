...
//[[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"http://itunes.apple.com/app/850204569"]];
    ...
    [storeProductViewController loadProductWithParameters:@{SKStoreProductParameterITunesItemIdentifier : @"951620447"} completionBlock:^(BOOL result, NSError *error) {
        if (error) {
...
//     [Flurry logEvent:@"Settings - Customer Feedback"];
    ...
    [pickerMail setToRecipients:[NSArray arrayWithObject:@"stripesapp@gmail.com"]];
    // Fill out the email body text
    NSString *emailBody = @"hi, I have the following feedback on stripes...";
...
//    if (indexPath.section == 1) {
//        if (indexPath.row==0) {
//            NSURL *instagramURL = [NSURL URLWithString:@"instagram://user?username=stripes"];
...
//        }
//        if (indexPath.row==2) {
//            NSURL *twitterURL = [NSURL URLWithString:@"twitter://user?screen_name=stripes"];
