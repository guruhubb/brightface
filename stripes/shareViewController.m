...
//        NSLog(@"share to facebook1");
        ...
        [controller setInitialText:@"#stripes created with stripes app"];
...
//    {
    if ([[UIApplication sharedApplication] canOpenURL:[NSURL URLWithString:@"twitter://"]]) {
        ...
        [tweetSheet setInitialText:@"#stripes created with @stripes"];
...
//        
//        [controller setInitialText:@"#stripes created with @stripes"];
//        [controller addImage:self.image];
//        
//        [self presentViewController:controller animated:YES completion:nil];
//        
...
//        NSLog(@"image size: %@", NSStringFromCGSize(instaImage.size));
    ...
    _docController.annotation = [NSDictionary dictionaryWithObject:@"#stripes created with @stripes" forKey:@"InstagramCaption"];
...
- (IBAction)sendMail:(UIButton *)sender  
{
    ...
    [pickerMail setSubject:@"I created a stripes!"];
...
//    NSString *encodedString = [inputData base64EncodedString];      //encode
    NSString *string= @"Check it out!  \n\n______\nCreated using stripes app.  Download for free! \nhttp://itunes.apple.com/app/id951620447";
//    if (isImage)
...
//    NSArray *recipents = @[@"12345678", @"72345524"];
    NSString *message = [NSString stringWithFormat:@"created using stripes app.  download for free! \nhttp://itunes.apple.com/app/id951620447"];
